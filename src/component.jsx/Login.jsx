...
const Login = () => {
  ...
  return (
    <div  className="bg-gray-900 w-[100vw] h-[100vh]  flex flex-col justify-center items-center text-white">
      {/* Icon Section */}
      <div className="mb-6">
        <MovieCreationIcon data-aos="fade-right"  style={{ color: '#ff5252', height: '70px', width: '70px' }} />
      </div>
